...
frame1 = tkinter.Label(
    root, text="Block1", width=10, bg="red", highlightbackground="green"
)
frame1.place(x=0, y=0)

frame2 = tkinter.Label(
    root, text="Block2", width=10, bg="green", highlightbackground="red"
)
...
tkinter.Button(root, text="Block1", command=block1).pack()
tkinter.Button(root, text="Block2", command=block2).pack()
tkinter.Button(root, text="Canvas", command=canvas3).pack()
tkinter.Button(root, text="All", command=all).pack()
tkinter.Button(root, text="Reset", command=reset).pack()
