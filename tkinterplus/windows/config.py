...
class Config(tkinter.Toplevel):
    ...
    def add_string(self, name, label=None, required=False) -> None:
        """Add a string option to the config"""
        VAR = tkinter.StringVar()
        tkinter.Label(self.option, text=label).grid(
            row=self._row, column=0, sticky=tkinter.E
        )
        tkinter.Entry(self.option, textvariable=VAR).grid(
    ...
    def add_boolean(self, name, label=None, required=False) -> None:
        ...
        tkinter.Checkbutton(
            self.option, variable=VAR, onvalue=True, offvalue=False
        ).grid(row=self._row, column=1, sticky=tkinter.W)
        if self.theme != None:
            self.theme.reloadStyleSheet()
        self._config[name] = VAR
        self._row += 1

    def add_integer(self, name, label=None, min=None, max=None, required=False) -> None:
        ...
        tkinter.Spinbox(
            self.option, textvariable=VAR, from_=min, to=max, increment=1
        ).grid(row=self._row, column=1, sticky=tkinter.W)
        if self.theme != None:
            self.theme.reloadStyleSheet()
        self._config[name] = VAR
    ...
    def add_float(self, name, label=None, min=None, max=None, required=False) -> None:
    ...
    def add_enum(self, name, label=None, required=False) -> None:
        ...
        tkinter.OptionMenu(self.option, VAR, *values).grid(
            row=self._row, column=1, sticky=tkinter.W
        )
        if self.theme != None:
            self.theme.reloadStyleSheet()
    ...
    def add_filename(self, name, label=None, required=False) -> None:
        """Add a file option to the config"""
        VAR = tkinter.StringVar()
        tkinter.Label(self.option, text=label).grid(
            row=self._row, column=0, sticky=tkinter.E
        )
        Input(self.option, "file", textvarable=VAR).grid(
            row=self._row, column=1, sticky=tkinter.W
        )
        if self.theme != None:
            self.theme.reloadStyleSheet()
    ...
    def add_directory(self, name, label=None, required=False) -> None:
        """Add a directory option to the config"""
        VAR = tkinter.StringVar()
        tkinter.Label(self.option, text=label).grid(
            row=self._row, column=0, sticky=tkinter.E
        )
        Input(self.option, "directory", textvarable=VAR).grid(
            row=self._row, column=1, sticky=tkinter.W
        )
        if self.theme != None:
            self.theme.reloadStyleSheet()
    ...
    def add_color(self, name, label=None, required=False) -> None:
    ...
    def add_object(self, name, label=None, required=False) -> None:
        if label != None:
