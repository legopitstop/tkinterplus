...
def playsound(widget, sound: str) -> None:
    plat = platform.system()
    if plat == "Windows":
        winsound.PlaySound(sound, winsound.SND_ASYNC)
    else:
        widget.bell()  # Use default bell if platform is not supported
    ...
    def body(self) -> None:
        ...
        if self.options.get("type") == OK:
            ...
            self.footer.add_button(
                text="Cancel", command=self.modal.destroy, **btn_options
            )
        elif self.options.get("type") == YESNO:
            self.footer.add_button(
                text="Yes", command=self.modal.destroy, **btn_options
            )
            ...
            self.footer.add_button(
                text="Retry", command=self.modal.destroy, **btn_options
            )
            self.footer.add_button(
                text="Cancel", command=self.modal.destroy, **btn_options
            )
...
def _show(title=None, message=None, _icon=None, _type=None, **options) -> str:
...
def askokcancel(title=None, message=None, **options) -> str:
    "Ask if operation should proceed; return true if the answer is ok"
    s = _show(title, message, QUESTION, OKCANCEL, **options)
    return s == OK


def askyesno(title=None, message=None, **options) -> str:
    "Ask a question; return true if the answer is yes"
    s = _show(title, message, QUESTION, YESNO, **options)
    return s == YES


def askyesnocancel(title=None, message=None, **options) -> str:
...
def askretrycancel(title=None, message=None, **options) -> str:
