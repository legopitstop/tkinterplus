...
class Picture(tkinter.Canvas):
    def __init__(self, master:tkinter.Tk, image:Image=None, width:int=None, height:int=None, text:str=None, fg:str=None, bg:str=None, textvariable:tkinter.StringVar=None):
    ...
    def update(self):
        ...
        if self.text!=None:
            self.create_text(self.width/2, self.height+20, text=self.text, fill=self.fg, justify=tkinter.CENTER, anchor=tkinter.S, tag='TEXT')
