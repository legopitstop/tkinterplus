...
from ... import MaterialIcon, Picture
...
class Slideshow(Picture):
    def __init__(self, master:Tk, images:list=None, buttons:bool=None, button:str=None, activecolor:str=None, disabledcolor:str=None, width:int=None, height:int=None, state:str=None, fg:str=None, bg:str=None):
        ...
        self.LEFT = MaterialIcon('keyboard_arrow_left', (45,45), self.button)
        self.RIGHT = MaterialIcon('keyboard_arrow_right', (45, 45), self.button)
        
        self.LEFT_ACTIVE = MaterialIcon('keyboard_arrow_left', (45,45), self.activecolor)
        self.RIGHT_ACTIVE = MaterialIcon('keyboard_arrow_right', (45, 45), self.activecolor)
        
        self.LEFT_DISABLED = MaterialIcon('keyboard_arrow_left', (45,45), self.disabledcolor)
        self.RIGHT_DISABLED = MaterialIcon('keyboard_arrow_right', (45, 45), self.disabledcolor)
