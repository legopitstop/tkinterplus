from tkinter import DISABLED, E, END, EW, NORMAL, INSERT, SEL_FIRST, SEL_LAST, Event, Toplevel, colorchooser, Text, Frame, Tk, Button
...
from ... import MaterialIcon, Footer, StyleType, FormatVar
...
class FormatText(Frame):
    ...
    def _controls(self):
        # ICONS
        self.ALIGN_LEFT = MaterialIcon('format_align_left', size=(24, 24), color=self.button_fg)
        self.ALIGN_CENTER = MaterialIcon('format_align_center', size=(24, 24), color=self.button_fg)
        self.ALIGN_RIGHT = MaterialIcon('format_align_right', size=(24, 24), color=self.button_fg)
        self.CODE = MaterialIcon('code', size=(24, 24), color=self.button_fg)
        self.EXIT_FULLSCREEN = MaterialIcon('fullscreen_exit', size=(24, 24), color=self.button_fg)
        self.BLOCKQUOTE = MaterialIcon('format_quote', size=(24, 24), color=self.button_fg)
        self.BOLD = MaterialIcon('format_bold', size=(24, 24), color=self.button_fg)
        self.CLEAR_FORMAT = MaterialIcon('format_clear', size=(24, 24), color=self.button_fg)
        self.ITALIC = MaterialIcon('format_italic', size=(24, 24), color=self.button_fg)
        self.ORDERED_LIST = MaterialIcon('format_list_numbered', size=(24, 24), color=self.button_fg)
        self.UNORDERED_LIST = MaterialIcon('format_list_bulleted', size=(24, 24), color=self.button_fg)
        self.FOREGROUND_COLOR = MaterialIcon('format_color_text', size=(24, 24), color=self.fg)
        self.BACKGROUND_COLOR = MaterialIcon('format_color_fill', size=(24, 24), color=self.bg)
        self.UNDERLINED = MaterialIcon('format_underlined', size=(24, 24), color=self.button_fg)
        self.FULLSCREEN = MaterialIcon('fullscreen', size=(24, 24), color=self.button_fg)
        ...
        self.STRIKETHROUGH = MaterialIcon('format_strikethrough', size=(24, 24), color=self.button_fg)
        ...
        self.strikethrough_btn = Button(self.toolbar,image=self.STRIKETHROUGH,command=lambda: self._style(StyleType.STRIKETHROUGH), **btn)
